...
public class LogedinUser_test extends Signuploginpage_starter {
    ...
    public void Existinguser_logedin() {
        ...
        Signupuserpage_steps.logoutbtn();
        Assert.assertTrue(Signuplogin_page.logintoyouracc.is(Condition.visible),"Log out check");
